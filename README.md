# ParlateCiDi - Olimpiadi della Cultura e del Talento
...
3. Avvia in modalità sviluppo (React + Electron): `npm run electron:dev`
4. Compila per il tuo OS: `npm run electron:build`
